  ...
  return (
    <form className={styles.form}>
      <fieldset>
        ...
        <label htmlFor="avatar" className={styles.customInputAvatart}> <span className={styles.avatarSpan}></span></label>
        <input type="file" id="avatar" name="avatar" className={styles.hideInput} />
      </fieldset>
      <fieldset>
      ...
      <fieldset>
        ...
        <textarea name="about-text-intersing" placeholder="Не более 300 символов"></textarea>
      </fieldset>
      <fieldset>
        <label>Семья, статус, домашние животные</label>
        <input type="file" name="about-file-family" />
        <p>Рекомендуемый размер фото 230х129</p>
        <textarea name="about-text-intersting" placeholder="Не более 300 символов"></textarea>
      </fieldset>
      <fieldset>
        <label>Из какой сферы пришёл? Кем работаешь?</label>
        <textarea name="work-before" placeholder="Не более 300 символов"></textarea>
      </fieldset>
      <fieldset>
